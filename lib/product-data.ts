...
export const hardcodedProducts = {
  "3": { // Cooling Gel Mattress - ID 3
    ...
    reasonsToBuy: ["Cooling Technology", "Motion Isolation", "Hypoallergenic", "100-Night Trial"],
    promotionalOffers: [],
    productQuestions: [],
  ...
  "2": { // Luxury Hybrid Mattress - ID 2
    ...
    dispatchTime: "Tomorrow",
    reasonsToBuy: ["Hybrid Technology", "Premium Materials", "Edge Support", "100-Night Trial"],
    promotionalOffers: [],
    productQuestions: [],
  ...
  "1": { // Simba Hybrid Pillow - ID 1
    ...
    setupService: false,
    setupCost: undefined,
    certifications: ["OEKO-TEX", "CertiPUR-US", "Made in UK", "100-Night Trial", "5-Year Warranty"],
    ...
    dispatchTime: "Tomorrow",
    reasonsToBuy: ["Hybrid Technology", "Cooling Properties", "Hypoallergenic", "100-Night Trial"],
    promotionalOffers: [],
    productQuestions: [],
  ...
  "4": { // Organic Natural Mattress - ID 4
    ...
    dispatchTime: "Tomorrow",
    reasonsToBuy: ["100% Organic", "Natural Materials", "Eco Friendly", "100-Night Trial"],
    promotionalOffers: [],
    productQuestions: [],
