...
export function getProductsByCategory(category: string): ProductRecord[] {
  const baseProducts: ProductRecord[] = [
    ...
    },
    {
      ...
      setupService: false,
      certifications: ['OEKO-TEX', 'Made in UK', '14-Night Trial', '5-Year Warranty'],
      sizes: ['Single', 'Double', 'King', 'Super King'],
      selectedSize: 'Double',
      monthlyPrice: 25,
      images: [
    ...
    },
    {
      ...
      freeDelivery: 'Tomorrow',
      setupService: false,
      certifications: ['OEKO-TEX', 'Made in UK', '14-Night Trial'],
      sizes: ['Single', 'Double', 'King', 'Super King'],
      selectedSize: 'Queen',
      monthlyPrice: 8,
    ...
    },
    {
      ...
      setupService: true,
      setupCost: 49,
      certifications: ['OEKO-TEX', 'Made in UK', '14-Night Trial', '10-Year Warranty'],
      sizes: ['Single', 'Double', 'King', 'Super King'],
      selectedSize: 'King',
      monthlyPrice: 55,
      images: ['https://images.unsplash.com/photo-1505693314120-0d443867891c?w=800&h=600&fit=crop'],
...
export const hardcodedProducts = {
  "3": { // Cooling Gel Mattress - ID 3
    ...
    setupService: false,
    setupCost: undefined,
    certifications: ["OEKO-TEX", "CertiPUR-US", "Made in UK", "14-Night Trial", "8-Year Warranty"],
    sizes: ["Single", "Double", "King", "Super King"],
    selectedSize: "Double",
    monthlyPrice: 32,
    ...
    materials: ["Gel Foam", "Memory Foam", "High-Density Foam"],
    dimensions: {
      height: "25cm",
      length: "200cm",
      width: "135cm",
      ...
      pocket_springs: "N/A",
      comfort_layer: "Gel Foam",
      support_layer: "High-Density Foam"
    },
    dispatchTime: "Tomorrow",
    reasonsToBuy: ["Cooling Technology", "Motion Isolation", "Hypoallergenic", "14-Night Trial"],
    promotionalOffers: [],
    productQuestions: [],
    warrantyInfo: { years: 8, coverage: "Full coverage" },
    careInstructions: "Regular vacuuming, spot clean only",
    stockQuantity: 15,
    inStock: true,
    shortDescription: "Advanced cooling gel mattress for temperature regulation",
    longDescription: "Experience ultimate comfort with our Cooling Gel Mattress featuring advanced temperature regulation technology."
  },
  "2": { // Luxury Hybrid Mattress - ID 2
    id: 2,
    ...
    setupService: true,
    setupCost: 49,
    certifications: ["OEKO-TEX", "CertiPUR-US", "Made in UK", "14-Night Trial", "15-Year Warranty"],
    sizes: ["Single", "Double", "King", "Super King"],
    selectedSize: "King",
    monthlyPrice: 57,
    images: ["/mattress-image.svg"],
    ...
    materials: ["Pocket Springs", "Memory Foam", "High-Density Foam"],
    dimensions: {
      height: "28cm",
      length: "200cm",
      width: "150cm",
      ...
      pocket_springs: "1000",
      comfort_layer: "Memory Foam",
      support_layer: "Pocket Springs"
    },
    dispatchTime: "Tomorrow",
    reasonsToBuy: ["Hybrid Technology", "Premium Materials", "Edge Support", "14-Night Trial"],
    promotionalOffers: [],
    productQuestions: [],
    warrantyInfo: { years: 15, coverage: "Full coverage" },
    careInstructions: "Regular vacuuming, rotate monthly",
    stockQuantity: 8,
    inStock: true,
    shortDescription: "Premium hybrid mattress with pocket springs and memory foam",
    longDescription: "Luxury hybrid mattress combining the best of pocket springs and memory foam for ultimate comfort and support."
  },
  "1": { // Simba Hybrid Pillow - ID 1
    id: 1,
    name: "Simba Hybrid Pillow",
    brand: "SIMBA",
    brandColor: "blue",
    badge: "TOP PICKS 2020",
    badgeColor: "orange",
    ...
    firmness: "MEDIUM",
    firmnessLevel: 5,
    features: ["Hybrid Technology", "Memory Foam", "Cooling Properties", "Hypoallergenic"],
    ...
    setupService: false,
    setupCost: undefined,
    certifications: ["OEKO-TEX", "CertiPUR-US", "Made in UK", "14-Night Trial", "5-Year Warranty"],
    ...
    price: 92.65,
    colors: ["White", "Gray"],
    materials: ["Memory Foam", "Polyester"],
    dimensions: {
      height: "15cm",
      length: "50cm",
      width: "30cm",
      mattress_size: "Standard",
      max_height: "20cm",
      weight_capacity: "N/A",
      pocket_springs: "N/A",
      comfort_layer: "Memory Foam",
      support_layer: "Polyester"
    },
    dispatchTime: "Tomorrow",
    reasonsToBuy: ["Hybrid Technology", "Cooling Properties", "Hypoallergenic", "14-Night Trial"],
    promotionalOffers: [],
    productQuestions: [],
    warrantyInfo: { years: 5, coverage: "Full coverage" },
    careInstructions: "Machine washable, air dry",
    stockQuantity: 25,
    inStock: true,
    shortDescription: "Premium hybrid pillow with memory foam and cooling properties",
    longDescription: "Experience ultimate comfort with our Simba Hybrid Pillow featuring advanced memory foam technology and cooling properties."
  },
  "4": { // Organic Natural Mattress - ID 4
    id: 4,
    ...
    setupService: true,
    setupCost: 49,
    certifications: ["GOTS Certified", "OEKO-TEX", "Made in UK", "14-Night Trial", "20-Year Warranty"],
    sizes: ["Single", "Double", "King", "Super King"],
    selectedSize: "King",
    monthlyPrice: 64,
    images: ["/mattress-image.svg"],
    ...
    materials: ["Organic Cotton", "Natural Latex", "Wool"],
    dimensions: {
      height: "30cm",
      length: "200cm",
      width: "150cm",
      mattress_size: "King",
      max_height: "35cm",
      weight_capacity: "180kg",
      pocket_springs: "N/A",
      comfort_layer: "Natural Latex",
      support_layer: "Organic Cotton"
    },
    dispatchTime: "Tomorrow",
    reasonsToBuy: ["100% Organic", "Natural Materials", "Eco Friendly", "14-Night Trial"],
    promotionalOffers: [],
    productQuestions: [],
    warrantyInfo: { years: 20, coverage: "Full coverage" },
    careInstructions: "Spot clean only, air regularly",
    stockQuantity: 5,
    inStock: true,
    shortDescription: "100% organic natural mattress with eco-friendly materials",
    longDescription: "Experience the ultimate in natural comfort with our 100% organic mattress featuring premium natural materials and eco-friendly construction."
  }
}

export function getHardcodedProduct(id: string | number) {
  const numericId = typeof id === 'string' ? parseInt(id, 10) : id
  return hardcodedProducts[numericId.toString() as keyof typeof hardcodedProducts] || null
}
